...
SELECT first_name, last_name FROM customer WHERE first_name LIKE '%nn%'; -- LIKE (case-sensitive)

SELECT first_name, last_name FROM customer WHERE first_name ILIKE '%nn%'; -- ILIKE (case-insensitive)  
...
UPDATE customer
SET first_name = 'JUSTIN', last_name = 'WALKER', email = 'justin123@tatvasoft.com'
WHERE customer_id = 1;
